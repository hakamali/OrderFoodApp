...
public class RecyclerItemTouchHelper  extends ItemTouchHelper.SimpleCallback{
    ...
    public RecyclerViewItemTouchHelperListener listener;

    public RecyclerItemTouchHelper(int dragDirs, int swipeDirs, RecyclerViewItemTouchHelperListener listener) {
