...
import com.example.lenghia.orderfoodapp.Common.DirectionJSONParser;
import com.example.lenghia.orderfoodapp.Model.Request;
import com.example.lenghia.orderfoodapp.Model.ShippingInformation;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback, ValueEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shippingOrder = database.getReference(Common.SHIPPER_INFO_TABLE);
